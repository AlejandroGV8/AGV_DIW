...
<body>
    <header>
        <div class="bienvenida">
            Bienvenido/a <?php echo $_SESSION['correo_usuario']; ?> estas editando el perifil de <?php echo $nombre ?>
        </div>
        <div class="acciones">
            <a href="logout.php">
    ...
    <div class="editar-perfil-formulario">
        <h2>Editar perfil</h2>
        <form method="post" action="./actualizarDesdeAdmin.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
